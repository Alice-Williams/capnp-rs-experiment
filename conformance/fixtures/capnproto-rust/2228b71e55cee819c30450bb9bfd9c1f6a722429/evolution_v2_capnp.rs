...
impl ::core::convert::TryFrom<u16> for State {
    ...
    fn try_from(value: u16) -> ::core::result::Result<Self, <State as ::core::convert::TryFrom<u16>>::Error> {
        match value {
            ...
            1 => ::core::result::Result::Ok(Self::Active),
...
pub(crate) static ENCODED_NODE: [::capnp::Word; 31] = [
    ...
    ::capnp::word(110, 45, 118, 50, 46, 99, 97, 112),
...
pub mod item {
    ...
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
            ...
            ::capnp::word(101, 118, 111, 108, 117, 116, 105, 111),
            ::capnp::word(110, 45, 118, 50, 46, 99, 97, 112),
            ::capnp::word(110, 112, 58, 73, 116, 101, 109, 0),
            ::capnp::word(0, 0, 0, 0, 1, 0, 1, 0),
...
pub mod record {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_state(self) -> ::core::result::Result<crate::evolution_v2_capnp::State,::capnp::NotInSchema> {
            ::core::convert::TryFrom::try_from(self.reader.get_data_field::<u16>(2))
        }
        #[inline]
        pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Reader<'a,crate::evolution_v2_capnp::item::Owned>> {
        ...
        #[inline]
        pub fn get_contact(self) -> crate::evolution_v2_capnp::record::contact::Reader<'a> {
            self.reader.into()
        }
        #[inline]
        pub fn get_audit(self) -> crate::evolution_v2_capnp::record::audit::Reader<'a> {
            self.reader.into()
        }
    }
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_state(&mut self, value: crate::evolution_v2_capnp::State)  {
            self.builder.set_data_field::<u16>(2, value as u16);
        }
        #[inline]
        pub fn get_values(self) -> ::capnp::Result<::capnp::struct_list::Builder<'a,crate::evolution_v2_capnp::item::Owned>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_values(&mut self, value: ::capnp::struct_list::Reader<'_,crate::evolution_v2_capnp::item::Owned>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
        pub fn init_values(self, size: u32) -> ::capnp::struct_list::Builder<'a,crate::evolution_v2_capnp::item::Owned> {
        ...
        #[inline]
        pub fn get_contact(self) -> crate::evolution_v2_capnp::record::contact::Builder<'a> {
            self.builder.into()
        }
        #[inline]
        pub fn init_contact(mut self, ) -> crate::evolution_v2_capnp::record::contact::Builder<'a> {
            self.builder.set_data_field::<u16>(3, 0);
            self.builder.reborrow().get_pointer_field(3).clear();
            self.builder.into()
        }
        #[inline]
        pub fn get_audit(self) -> crate::evolution_v2_capnp::record::audit::Builder<'a> {
            self.builder.into()
        }
        #[inline]
        pub fn init_audit(self, ) -> crate::evolution_v2_capnp::record::audit::Builder<'a> {
    ...
    impl Pipeline  {
        pub fn get_contact(&self) -> crate::evolution_v2_capnp::record::contact::Pipeline {
            ::capnp::capability::FromTypelessPipeline::new(self._typeless.noop())
        }
        pub fn get_audit(&self) -> crate::evolution_v2_capnp::record::audit::Pipeline {
            ::capnp::capability::FromTypelessPipeline::new(self._typeless.noop())
        }
    }
    mod _private {
        pub(crate) static ENCODED_NODE: [::capnp::Word; 114] = [
            ...
            ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
            ::capnp::word(173, 0, 0, 0, 188, 1, 0, 0),
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                0 => <u32 as ::capnp::introspect::Introspect>::introspect(),
                1 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
                2 => <crate::evolution_v2_capnp::State as ::capnp::introspect::Introspect>::introspect(),
                3 => <::capnp::struct_list::Owned<crate::evolution_v2_capnp::item::Owned> as ::capnp::introspect::Introspect>::introspect(),
                4 => <::capnp::text::Owned as ::capnp::introspect::Introspect>::introspect(),
                5 => <crate::evolution_v2_capnp::record::contact::Owned as ::capnp::introspect::Introspect>::introspect(),
                6 => <crate::evolution_v2_capnp::record::audit::Owned as ::capnp::introspect::Introspect>::introspect(),
                _ => ::capnp::introspect::panic_invalid_field_index(index),
            }
        }
        pub(crate) fn get_annotation_types(child_index: Option<u16>, index: u32) -> ::capnp::introspect::Type {
        ...
        pub(crate) static MEMBERS_BY_DISCRIMINANT : &[u16] = &[];
        pub(crate) static MEMBERS_BY_NAME : &[u16] = &[6,5,4,0,1,2,3];
    ...
    pub mod audit {
        ...
        mod _private {
            pub(crate) static ENCODED_NODE: [::capnp::Word; 48] = [
                ...
                ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
                ::capnp::word(120, 1, 0, 0, 186, 1, 0, 0),
