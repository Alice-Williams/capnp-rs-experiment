...
pub(crate) static ENCODED_NODE: [::capnp::Word; 27] = [
    ...
    ::capnp::word(110, 45, 118, 49, 46, 99, 97, 112),
...
pub mod record {
    ...
    impl <'a,> Reader<'a,>  {
        ...
        #[inline]
        pub fn get_state(self) -> ::core::result::Result<crate::evolution_v1_capnp::State,::capnp::NotInSchema> {
            ::core::convert::TryFrom::try_from(self.reader.get_data_field::<u16>(2))
        }
        #[inline]
        pub fn get_values(self) -> ::capnp::Result<::capnp::primitive_list::Reader<'a,u32>> {
    ...
    impl <'a,> Builder<'a,>  {
        ...
        #[inline]
        pub fn set_state(&mut self, value: crate::evolution_v1_capnp::State)  {
            self.builder.set_data_field::<u16>(2, value as u16);
        }
        #[inline]
        pub fn get_values(self) -> ::capnp::Result<::capnp::primitive_list::Builder<'a,u32>> {
            ::capnp::traits::FromPointerBuilder::get_from_pointer(self.builder.get_pointer_field(1), ::core::option::Option::None)
        }
        #[inline]
        pub fn set_values(&mut self, value: impl ::capnp::traits::SetterInput<::capnp::primitive_list::Owned<u32>>) -> ::capnp::Result<()> {
            ::capnp::traits::SetterInput::set_pointer_builder(self.builder.reborrow().get_pointer_field(1), value, false)
        }
        #[inline]
        pub fn init_values(self, size: u32) -> ::capnp::primitive_list::Builder<'a,u32> {
    ...
    mod _private {
        ...
        pub(crate) fn get_field_types(index: u16) -> ::capnp::introspect::Type {
            match index {
                ...
                2 => <crate::evolution_v1_capnp::State as ::capnp::introspect::Introspect>::introspect(),
