...
m40_soak_results=${M40_SOAK_RESULT_DIR:?set M40_SOAK_RESULT_DIR to the recorded M40 result directory}
...
bash tools/verify-m40-soak-result.sh "$m40_soak_results"
