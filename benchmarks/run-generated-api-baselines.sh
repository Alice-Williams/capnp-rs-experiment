...
runs=${BENCH_RUNS:-9}
passes=${GENERATED_API_BENCH_PASSES:-100000}
...
cpp_build="$cpp_root/generated-api-benchmark"
mkdir -p -- "$cpp_build"
...
cargo build --locked --manifest-path "$repo_root/Cargo.toml" \
    --package capnp-generated-fixture --example generated_api_benchmark --release >/dev/null
...
python3 "$repo_root/tools/summarize-generated-api-benchmarks.py" \
