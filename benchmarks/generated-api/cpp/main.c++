...
int main(int argc, char** argv) {
  if (argc != 4) {
    std::cerr << "usage: cpp-generated-api direct-scalars|generated-scalars|direct-blobs|generated-blobs PASSES FIXTURE\n";
    return 2;
  }
  ...
  } else if (mode == "generated-scalars") {
